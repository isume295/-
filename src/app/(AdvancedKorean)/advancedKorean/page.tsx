                    ...
                    <div className='flex flex-col items-center justify-center border w-[516px] mt-4 h-[208px] '>
                        ...
                        <div className='w-[516px] h-[76px] border-b border-[#CFD4DA] flex flex-row items-start justify-start'>
                            ...
                            <div className='flex flex-col items-start justify-start w-[431px] h-[76px] p-[8px] gap-[4px]'>
                                <div className='flex flex-row items-start justify-start'>
                                    <p className='text-[12px] py-[4px] px-[8px] gap-[10px] text-[#868F9A]'>공국(미)</p>
                                    <p className='text-[12px] py-[4px] px-[8px] gap-[10px] text-[#868F9A]'>공국(비강)</p>
                                    <p className='text-[12px] py-[4px] px-[8px] gap-[10px] text-[#868F9A]'>공국(비박)</p>
                                    <p className='text-[12px] py-[4px] px-[8px] gap-[10px] text-[#868F9A]'>공국(천 김수)</p>
                                    <p className='text-[12px] py-[4px] px-[8px] gap-[10px] text-[#868F9A]'>공국(천 김종)</p>
                                </div>

                                <div className='flex flex-row items-start justify-start'>
                                    <p className='text-[12px] py-[4px] px-[8px] gap-[10px] text-[#868F9A]'>공국(지)</p>
                                    <p className='text-[12px] py-[4px] px-[8px] gap-[10px] text-[#868F9A]'>공국(창)</p>
                                    <p className='text-[12px] py-[4px] px-[8px] gap-[10px] text-[#868F9A]'>공국(해)</p>
                                    <p className='text-[12px] py-[4px] px-[8px] gap-[10px] text-[#868F9A]'>공국(동)</p>
                                </div>
                        ...
                        <div className='w-[516px] h-[44px] border-b border-[#CFD4DA] flex flex-row items-start justify-start'>
                            <div className='flex flex-row items-start justify-start w-[85px] h-[44px] p-[12px] border-b border-[#CFD4DA] bg-[#F3F4F6] gap-[4px]'>
                                <div className='flex flex-row items-center justify-between'>
                                        <Checkbox  size='sm' />
                                        <p className='w-[42px] h-[17px] text-[10px] text-[#868F9A] font-bold'> 분야 </p>
                                </div>   
                            </div>
                            <div className='flex flex-row items-start justify-start w-[431px] h-[44px] p-[8px] gap-[4px]'>
                                ...
                                <p className='text-[12px] py-[4px] px-[8px] gap-[10px] text-[#868F9A]'>언어와 매체</p>
                        ...
                        <div className='w-[516px] h-[44px] border-b border-[#CFD4DA] flex flex-row items-start justify-start'>
                            ...
                            <div className='flex flex-row items-start justify-start w-[431px] h-[44px] p-[8px] gap-[4px]'>
                                ...
                                <p className='text-[12px] py-[4px] px-[8px] gap-[10px] text-[#868F9A]'>연관 문제</p>
