...
const BulletInBoardCommunityAdmin = () => {
    const options = [
        { key: "1", label: "전체" },
    ]
    ...
    return (
        <div className="min-h-[2949px] flex flex-col items-center justify-between">
            ...
            <div className='flex flex-row  justify-between w-[1080px] h-[2570px] gap-[36px]'>
                ...
                {/* RightSide */}
                <div className='flex flex-col items-center justify-center w-[824px] h-[800px] pb-[20px] gap-[40px]'>
                    {/* Top  */}
                    <div className='flex flex-col items-center justify-center w-[824px] h-[54px]'>

                            <div className='w-[824px] h-[34px] pl-2 '>
                                <h3 className='font-bold text-[24px]'>가입인사</h3>
                            </div>
                    ...
                    <div className='w-[824px] gap-[20px]'>
                        <div className="flex flex-row items-center pl-2 justify-between w-[824px] h-[36px]">
...
export default BulletInBoardCommunityAdmin;
