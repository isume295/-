...
const PaymentDetails = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-between">
      ...
      {/* Form Container */}
      <div className="flex flex-col items-center justify-start w-full h-[1000px] gap-[10px] mt-10 mb-80 flex-1">
        ...
        {/* ----- ---- --- BOTTOM  --- ----- ------*/}
        <div className='flex flex-col items-center justify-center w-[1080px] h-[582px] gap-[12px]'>
