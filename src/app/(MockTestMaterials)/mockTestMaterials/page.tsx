                    ...
                    <div className='flex flex-col items-center justify-center border w-[516px] h-[220px] '>
                        ...
                        <div className='w-[516px] h-[44px] border-b border-[#CFD4DA] flex flex-row items-start justify-start'>
                            ...
                            <div className='flex flex-row items-start justify-start w-[431px] h-[44px] p-[8px] gap-[4px]'>
                                <p className='text-[12px] border border-[#42A8FD] rounded-full py-[4px] px-[8px] gap-[10px] text-[#42A8FD]'>고1</p>
                                <p className='text-[12px] border border-[#42A8FD] rounded-full py-[4px] px-[8px] gap-[10px] text-[#42A8FD]'>고2</p>
                                <p className='text-[12px] border border-[#42A8FD] rounded-full py-[4px] px-[8px] gap-[10px] text-[#42A8FD]'>고3</p>
                        ...
                        <div className='w-[516px] h-[44px] border-b border-[#CFD4DA] flex flex-row items-start justify-start'>
                            ...
                            <div className='flex flex-row items-start justify-start w-[431px] h-[44px] p-[8px] gap-[4px]'>
                                <p className='text-[12px] border border-[#42A8FD] rounded-full py-[4px] px-[8px] gap-[10px] text-[#42A8FD]'>2025</p>
                                <p className='text-[12px] border border-[#42A8FD] rounded-full py-[4px] px-[8px] gap-[10px] text-[#42A8FD]'>2024</p>
