    ...
    return (
        <div className="min-h-[2949px] flex flex-col items-center justify-between">
            ...
            <div className='flex flex-row  justify-between w-[1080px] gap-[36px]'>
                ...
                {/* RightSide */}
                <div className='flex flex-col items-center justify-center w-[814px] h-[795px] gap-[24px]'>
                    {/* Heading  */}
                    <div className='flex flex-col items-center w-full h-[108px] py-[24px] border-b gap-[12px]'>
                        ...
                        <div className="flex flex-row items-center w-full h-full justify-between">
                            <div className="flex flex-row items-start justify-start w-[220px] h-[20px] gap-[12px]">

                                <h3 className='text-[#868F9A] text-[14px]'>idid1234</h3>
                                <h3 className='text-[#868F9A] text-[14px]'>2024.11.01</h3>
                                <h3 className='text-[#868F9A] text-[14px]'>조회수 100</h3>

                            </div>

                            <div className="flex flex-row items-center w-[160px] h-[20px] gap-[9px]">
                                ...
                                <p className='text-[14px] text-[#42A8FD]'>등록</p>
                                <p className='text-[14px] text-[#868F9A]'>수정</p>
                                <p className='text-[14px] text-[#ED3D2E]'>삭제</p>
                    ...
                    <div className='flex flex-row items-center justify-between w-[800px] h-[33px]'>
                        ...
                        <div className="flex flex-row items-center justify-center w-[210px] h-[33px] gap-[8px]">
                            ...
                            {/* Button */}
                            <Button
                                className=" border-2 font-bold bg-[#FFF] text-[12px] text-[#868F9A] rounded-md p-0"
                            >
                                목록
                            </Button>
                        </div>
                    ...
                    <div className="w-[814px] h-[198px]">
                        ...
                        <div className="flex flex-col items-start justify-between w-[814px] h-[176px]">
                            <div className="flex flex-row w-full h-[88px] items-start justify-start border-b py-[20px] gap-[20px]">
                                
                                <div className="w-[51px] h-[22px] text-[16px] text-[#868F9A] font-bold">id1234</div>

                                <div className="flex flex-col items-start w-[699px] h-[48px] gap-1">
                                    <div className="">좋은 자료 감사합니다.</div>
                            ...
                            <div className="flex flex-row w-full h-[88px] items-start justify-start py-[20px] gap-[20px]">
                                
                                <div className="w-[51px] h-[22px] text-[16px] text-[#868F9A] font-bold">aaa111</div>

                                <div className="flex flex-col items-start w-[699px] h-[48px] gap-1">
                                    <div className="">감사합니다!</div>
...
export default PostDetailsAdmin2;
