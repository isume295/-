  ...
  return (
    <div className="min-h-[1117px] flex flex-col items-center justify-between"> 
      ...
      <div className="flex flex-col items-center justify-start w-[428px] h-[293px] gap-[10px] mt-10 mb-96 flex-1">
            ...
            {/* ----- ---- --- BOTTOM  --- ----- ------*/}
            <div className='flex flex-col items-center justify-center w-[1080px] h-[582px] gap-[4px]'>
                ...
                <div className="flex flex-row items-center justify-center w-full gap-[12px]">
                    ...
                    <div className=' border border-[#868F9A]  text-[#868F9A] px-[12px] py-[10px] text-[14px] rounded-full'>1:1 문의</div>
                </div>
                ...
                <article className="mt-5">
                  <Table
                    ...
                    classNames={{
                      th: [
                        "relative px-[40px] py-[10px] font-bold text-[14px] bg-[#F3F4F6] text-[#868F9A] h-[44px] text-center",
