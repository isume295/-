            ...
            <div className='flex flex-col items-center justify-center w-[824px] h-[1191px] py-[60px] gap-[40px]'>
                ...
                <div className='flex flex-col items-center justify-center w-[824px] h-[266px] py-4 gap-[12px]'>
                    <div className='flex flex-col items-center justify-center w-[824px] h-[34px] '>
                        <h3 className='font-bold text-[24px]'>중학 국어 교과서 자료<span className='font-normal text-[16px] text-[#868F9A]'>(2022 개정)</span></h3>
                    ...
                    <div className='flex flex-col items-center justify-center border w-[516px] mt-4 h-[208px] '>
                        ...
                        <div className='w-[516px] h-[44px] border-b border-[#CFD4DA] flex flex-row items-start justify-start'>
                            <div className='flex flex-row items-start justify-start w-[85px] h-[44px] p-[12px] border-b border-[#CFD4DA] bg-[#F3F4F6] gap-[4px]'>
                                <div className='flex flex-row items-center justify-between'>
                                        <Checkbox  size='sm' />
                                        <p className='w-[42px] h-[17px] text-[10px] text-[#868F9A] font-bold'> 종류 </p>
                                </div>
                            </div>
                            <div className='flex flex-row items-start justify-start w-[431px] h-[44px] p-[8px] gap-[4px]'>
                                <p className='text-[12px] rounded-full py-[4px] px-[8px] gap-[10px] text-[#868F9A]'>중 1-1</p>
                                <p className='text-[12px] rounded-full py-[4px] px-[8px] gap-[10px] text-[#868F9A]'>중 1-2</p>
                                <p className='text-[12px] rounded-full py-[4px] px-[8px] gap-[10px] text-[#868F9A]'>중 2-1</p>
                                <p className='text-[12px] rounded-full py-[4px] px-[8px] gap-[10px] text-[#868F9A]'>중 2-2</p>
                                <p className='text-[12px] rounded-full py-[4px] px-[8px] gap-[10px] text-[#868F9A]'>중 3-1</p>
                                <p className='text-[12px] rounded-full py-[4px] px-[8px] gap-[10px] text-[#868F9A]'>중 3-2</p>
                        ...
                        <div className='w-[516px] h-[76px] border-b border-[#CFD4DA] flex flex-row items-start justify-start'>
                            ...
                            <div className='flex flex-col items-start justify-start w-[431px] h-[76px] p-[8px] gap-[4px]'>
                                <div className='flex flex-row items-start justify-start'>
                                    <p className='text-[12px] py-[4px] px-[8px] gap-[10px] text-[#868F9A]'>미(신)</p>
                                    <p className='text-[12px] py-[4px] px-[8px] gap-[10px] text-[#868F9A]'>미(민)</p>
                                    <p className='text-[12px] py-[4px] px-[8px] gap-[10px] text-[#868F9A]'>비(박현)</p>
                                    <p className='text-[12px] py-[4px] px-[8px] gap-[10px] text-[#868F9A]'>비(박영)</p>
                                    <p className='text-[12px] py-[4px] px-[8px] gap-[10px] text-[#868F9A]'>천(정)</p>
                                    <p className='text-[12px] py-[4px] px-[8px] gap-[10px] text-[#868F9A]'>천(노)</p>
                                    <p className='text-[12px] py-[4px] px-[8px] gap-[10px] text-[#868F9A]'>지</p>
                                    <p className='text-[12px] py-[4px] px-[8px] gap-[10px] text-[#868F9A]'>동</p>
                                </div>

                                <div className='flex flex-row items-start justify-start'>
                                    <p className='text-[12px] py-[4px] px-[8px] gap-[10px] text-[#868F9A]'>창</p>
                                    <p className='text-[12px] py-[4px] px-[8px] gap-[10px] text-[#868F9A]'>해</p>
                                </div>
                        ...
                        <div className='w-[516px] h-[44px] border-b border-[#CFD4DA] flex flex-row items-start justify-start'>
                            ...
                            <div className='flex flex-row items-start justify-start w-[431px] h-[44px] p-[8px] gap-[4px]'>
                                ...
                                <p className='text-[12px] py-[4px] px-[8px] gap-[10px] text-[#868F9A]'>예상 문제</p>
                                <p className='text-[12px] py-[4px] px-[8px] gap-[10px] text-[#868F9A]'>직전 대비</p>
