            ...
            <div className='flex flex-row  justify-between w-[1080px] gap-[36px]'>
                ...
                <div className='flex flex-col items-center justify-center w-[824px] h-[654px] gap-[40px] p-[60px]'>
                    ...
                    <div className="flex flex-col w-[824] h-[89px] gap-[10px] pt-3">
                        <div className="flex flex-row items-start justify-start w-[824px] h-[20px] gap-[12px]">
                            <Checkbox><span className='text-[14px]'>포인트 사용</span></Checkbox>
                            <p className='text-[12px] text-[#868F9A] pt-1'>사용가능 : 2,000원</p>
                        </div>
                    ...
                    <div className="flex flex-row w-[824px] h-[42px] items-center justify-center">
